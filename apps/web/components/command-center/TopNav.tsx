...
export function TopNav({ mode = "genie", onModeChange, onToggleMenu, menuOpen = false }: TopNavProps) {
  return (
        ...
        <div className="flex items-center gap-1.5">
          <div className="inline-flex items-center gap-1 rounded-lg border border-[#6f9cb7] bg-[#123750]/70 p-1">
            ...
            <button
              ...
              className={`inline-flex items-center gap-1 rounded-md border px-2 py-1 text-[11px] font-semibold uppercase tracking-[0.06em] transition ${
                menuOpen
                  ? "border-[#9fd2ef] bg-[#2a668d]/95 text-[#f0f9ff]"
                  : "border-[#6b97b4] bg-[#17435f]/70 text-[#d8eaf7] hover:bg-[#1f5678]/85"
              }`}
              aria-label={menuOpen ? "Hide side panel" : "Show side panel"}
            >

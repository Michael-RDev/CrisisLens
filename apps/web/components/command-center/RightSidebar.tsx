  ...
  return (
    <>
      <button
        ...
        className="pointer-events-auto fixed bottom-4 right-4 z-40 rounded-full border border-[#85b6d5] bg-[#1f5678]/85 px-4 py-2 text-sm text-[#eff8ff] backdrop-blur md:hidden"
      >
        Open Panel
      </button>
      ...
      <motion.aside
        ...
        className="pointer-events-auto fixed inset-y-16 right-3 z-30 hidden flex-col rounded-2xl border border-white/20 bg-[#d4e8fa1c] p-3 shadow-[0_18px_50px_-24px_rgba(13,36,58,0.55)] backdrop-blur-md md:flex"
      >
        <div className="mb-2 flex items-start justify-between gap-2">
          {collapsed ? null : (
            <div className="min-w-0">
              ...
              <p className="m-0 mt-0.5 text-[10px] text-[#b7cedd]">Last refresh {new Date(generatedAt).toLocaleTimeString()}</p>
            </div>
          )}
          <button
            type="button"
